...
- Let TypeScript infer simple local types; add explicit types for exported/public APIs, module boundaries, callback contracts, complex generics, recursive functions, and anywhere inference is unclear, misleading, or materially improves readability.
