...
description: 'Short always-on web accessibility guardrails for frontend implementation. Use the accessibility-review skill for deep WCAG audits, checklists, and testing workflows.'
---

# Accessibility Guardrails

Apply these lightweight rules when building or changing frontend UI. Keep deep WCAG audits, legal context, framework checklists, and test planning in the `accessibility-review` skill so ordinary coding stays focused.
