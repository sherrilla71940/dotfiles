#!/usr/bin/env bash
# Seeds the auth tree the fixture state describes, plus the retry helper the prompt asks
# about. Leaves session.ts and refresh.ts modified, matching the Status the state records.
set -euo pipefail
